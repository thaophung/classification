...
model_def = caffe_root + 'examples/mnist/math_deploy.prototxt'
...
net.blobs['data'].reshape(1, 3, 72, 32)
fig=plt.figure()
image=caffe.io.load_image(caffe_root + 'data/math/train_first/2/0000002.JPEG')
transformed_image=transformer.preprocess('data', image)
img = Image.open(caffe_root + 'data/math/train_first/2/0000002.JPEG')
img.save('./test/test_image1digit_2.JPEG')
...
script=argv
target=open('./test/top5_pred_1dig_2.txt','w')
